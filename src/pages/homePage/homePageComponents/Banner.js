...
const Banner = () => {
  ...
  return (
    <section id="banner" className="bg-[#98d0e2] py-16">
        ...
        <div className="col-span-1 md:col-span-2">
          <div className="mb-7 md:mb-5">
            ...
            <TypeAnimation
              ...
              wrapper="h2"
              repeat={Infinity}
              className="text-3xl sm:text-5xl md:text-6xl font-bold text-[#ed4249] mb-3 md:mb-5 lg:mb-8"
            />
          ...
          <div className="flex flex-wrap justify-start gap-2 mt-5">
            ...
            <p className="bg-[#ed4249] p-1 text-white cursor-pointer rounded-lg text-sm ">
              Web Designer
            </p>
            <p className="bg-[#ed4249] p-1 text-white cursor-pointer rounded-lg text-sm ">
              Web Development
