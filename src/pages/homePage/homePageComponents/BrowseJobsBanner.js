      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 py-16 items-center container mx-auto px-5">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-accent mb-3 md:mb-5">
            <span className="text-[#048cbc]">7,000+</span>
            Browse Jobs
          </h1>
          ...
          <Link
            to="/jobs"
            className="btn w-[200px] rounded-none duration-700 flex itmes-center px-4 md:px-7 py-3 bg-[#048cbc] hover:bg-transparent text-white border-[#048cbc] hover:border-primary hover:text-primary font-bold border-2 hover:border-2"
          >
