    ...
    <footer>
      ...
      <div className="bg-[#F9FCFF] py-16">
        <div className="grid px-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 container mx-auto text-base-100">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#048cbc]">Quick Links</h2>
            <ul className="mt-5">
              <li className="flex justify-start text-neutral gap-1 mb-3 hover:text-accent">
                <BiRightArrowAlt className="text-[#048cbc]" />
          ...
          <div>
            <h2 className="text-2xl font-bold mb-5 text-[#048cbc]">Contact Us</h2>
            <div className="flex justify-start items-center gap-3 mb-3">
              <div className="text-white text-2xl bg-[#048cbc] p-2 rounded">
                <MdLocationOn />
              </div>
            ...
            <div className="flex justify-start items-center gap-3 mb-3">
              <div className="text-2xl text-white bg-[#048cbc] p-2 rounded">
                <BsFillTelephoneFill />
              </div>
              <div className="text-neutral">
                <h4>7654656384658</h4>
      ...
      <div className="p-4 bg-[#222] text-base-100">
        <div className="flex justify-center items-center">
          <p className="text-xs">
            Copyright © 2023 - All right reserved: Aries
          </p>
        </div>
      </div>
    </footer>
